...
export function getFeedbacksByBookId(http: HttpClient, rootUrl: string, params: GetFeedbacksByBookId$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseObject>> {
