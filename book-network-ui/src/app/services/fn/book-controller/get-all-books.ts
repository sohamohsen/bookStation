...
export function getAllBooks(http: HttpClient, rootUrl: string, params?: GetAllBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseObject>> {
...
getAllBooks.PATH = '/books/get-all-books';
